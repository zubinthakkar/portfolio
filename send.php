...
$recipient = "thakkar.zubin@gmail.com";// Change the recipient email adress to your adrees  
$subjet =  "Inquiry from $name";// This is subject you can change it
$mailheaders = "From: $email\r\nReply-To: $email\r\nReturn-Path: $email\r\n";

if (!$error){

		$sending = mail($recipient, $subjet, $msg, $mailheaders); 
